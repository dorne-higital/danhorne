...
export default {
	...
	group: 'Sections',
	fields: [
		{ name: 'statLabel', label: 'Panel stat (e.g. "04 projects")', type: 'text', default: '' },
		{ name: 'heading', label: 'Panel heading', type: 'text', default: 'Selected work' },
		{ name: 'ctaLabel', label: 'Panel link label', type: 'text', default: 'View all' },
		{ name: 'ctaHref', label: 'Panel link', type: 'text', default: '' },
